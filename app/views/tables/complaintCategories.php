            ...
            <div class="card-body">
                ...
                <table class="table table-responsive-md" id="categoryTable">
                    ...
                    <tbody>
                        ...
                        foreach ($listComplaintCategory as $result) { ?>
                            <tr>
...
<script>
    ...
    $(document).on('click', '.editCategory', function() {
        ...
        saveForm(formData, "/forms/complaintCategoriesEdit", function(response) {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function() {
                        var formData = {};
                        formData.catid = catid; 
                        saveForm(formData, "/delete/complaintCategory", function(response) {
