...
<head>
	<title>Inspector - Signum Properties Ltd</title>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="<?php echo URLROOT ?>/pages/dailyInspection">Daily Inspections</a></li>
                            ...
                            <li><a href="<?php echo URLROOT ?>/pages/emergencyInspection">Emergency Inspection</a></li> 
                            <li><a href="<?php echo URLROOT ?>/pages/tenantFeedback">Tenant Feedback</a></li>     
                        </ul>
                    </li>
