                                            ...
                                            <div class="wizard-step-1 d-block">
                                                <form class="row" id="needs-validation" novalidate="" autocomplete="off">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-12">
                                                        ...
                                                        <input type="text" name="propertyCategory" class="form-control" placeholder="Single-family home, Duplex, Office building" required>
                                                    </div>
                                                    <div class="form-group col-md-4 col-sm-12">
       ...
       $('#facilities').SumoSelect({
       	...
       	$("#saveProperty").on("click", function() {
            ...
            var formData = {
                ...
                propertyCategory: $("input[name='propertyCategory']").val(),
