								...
								<div class="card-body pb-0">
									<div class="pb-3 border-bottom mb-3">
										<div class="d-flex mb-3 flex-wrap align-items-end">
											<img class="rounded me-3" src="<?php echo URLROOT ?>/assets/images/customers/1.jpg" width="58" alt="/">
											<div>
									...
									<div class="pb-3 mb-3">
										<div class="d-flex mb-3 flex-wrap align-items-end">
											<img class="rounded me-3" src="<?php echo URLROOT ?>/assets/images/customers/2.jpg" width="58" alt="/">
											<div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="testimonial-one owl-carousel">
										<div class="items">
											<a href="property-details.html"><img src="<?php echo URLROOT ?>/assets/images/testimonial/1.png" alt="#" class="w-100 mw-100 mb-3 rounded"></a>
										...
										<div class="items">
											<a href="property-details.html"><img src="<?php echo URLROOT ?>/assets/images/testimonial/2.png" alt="#" class="w-100 mw-100 mb-3 rounded"></a>
