                ...
                <form id="needs-validation1" novalidate="" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <input type="text" class="form-control-plaintext" readonly onkeypress="allowTwoDecimalPlaces(event)" id="amountPaid" value="<?php echo Billings::clientRentAmount($clientid); ?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
                            <label class="form-label">Bill Type</label>
                            <input type="text" class="form-control-plaintext" id="billType" readonly value="Rent">
                        </div>
                        <div class="form-group col-md-4 col-sm-12">
