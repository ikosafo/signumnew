            ...
            <div class="card-body wizard-box">
                <form class="row" id="needs-validation" novalidate="" autocomplete="off">
                    <div class="mb-3 col-md-6 col-sm-12">
                        ...
                        <input type="text" name="activityName" class="form-control" value="<?= $activityName ?>"
                    ...
                    <div class="col-sm-12 text-center">
                        <button type="submit" id="updateActivity" class="btn btn-warning btn-sm">Update Activity</button>
