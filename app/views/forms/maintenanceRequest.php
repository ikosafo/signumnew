...
<script>
    ...
    $("#complaintType").selectpicker({
        placeholder:"Select Type"
    });   
    
    $("#priorityLevel").selectpicker({
        placeholder:"Select Priority Level"
    });

    $("#occurenceDate").flatpickr();

    $("#complaintPriority").selectpicker({
        placeholder: "Select Priority"
    });

    $("#contactMethod").selectpicker({
        placeholder: "Select Method"
    });

    $("#expectedResolutionTime").selectpicker({
        placeholder: "Select Period"
    });

    $("#incidentSeverity").selectpicker({
    ...
    $("#saveComplaintDetails").on("click", function(event) {
        ...
        var clientData = {
            propertyName: <?php echo $propertyid ?>,
